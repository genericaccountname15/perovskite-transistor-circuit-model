...
def fit_leastsq(Z, bias_data, nobias_data, bias_voltage, IV_data=None, run_checker=False, bias=True, nanoparticles=False, fixed_params_indices = [], fixed_params_values = []):
    """
...
if __name__ == "__main__":
    ...
    plist_fit = fit_leastsq(Z, bias_data, nobias_data, bias_voltage, IV_data, False, True, fixed_params_indices=[7], fixed_params_values=[bias_voltage])
